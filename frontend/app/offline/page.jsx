...
export default function OfflinePage() {
  return (
    <div style={{ minHeight: '100vh', background: '#0a0f1e', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'Inter, sans-serif', color: '#f1f5f9', textAlign: 'center', padding: '20px' }}>
      <div>
        <div style={{ fontSize: '64px', marginBottom: '24px' }}>🚌</div>
        <h1 style={{ fontSize: '28px', fontWeight: 800, marginBottom: '12px', fontFamily: 'Space Grotesk, sans-serif' }}>You're Offline</h1>
        <p style={{ color: '#94a3b8', fontSize: '15px', marginBottom: '24px', maxWidth: '340px' }}>
