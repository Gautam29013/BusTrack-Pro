    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', overflow: 'hidden' }}>
      ...
      <div style={{ padding: '14px 16px', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
        <div style={{ position: 'relative' }}>
          <svg style={{ position: 'absolute', left: '12px', top: '50%', transform: 'translateY(-50%)', color: '#475569' }} width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
      ...
      {/* Count */}
      <div style={{ padding: '10px 16px 6px', fontSize: '12px', color: '#475569', fontWeight: 500 }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '6px', marginBottom: '3px' }}>
                          ...
                          {bus.isDeviated && (
                            <span style={{ fontSize: '10px', fontWeight: 700, color: '#f43f5e', background: 'rgba(244,63,94,0.1)', padding: '1px 5px', borderRadius: '99px', border: '1px solid rgba(244,63,94,0.3)' }}>⚠️</span>
                          )}
                          <span className="badge badge-green" style={{ fontSize: '10px' }}>Live</span>
                        </div>
                        <div style={{ fontSize: '12px', color: '#94a3b8', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', marginBottom: '4px' }}>
                      ...
                      <div style={{ textAlign: 'right', flexShrink: 0 }}>
                        {bus.eta_minutes && (
                          <div style={{ fontSize: '14px', fontWeight: 800, color: bus.eta_minutes <= 2 ? '#f43f5e' : '#3b82f6', fontFamily: 'Space Grotesk, sans-serif' }}>
                            {bus.eta_minutes}<span style={{ fontSize: '10px', fontWeight: 400, color: '#475569' }}> min</span>
                          </div>
                        )}
                        <div style={{ fontSize: '11px', fontWeight: 600, color: '#f1f5f9' }}>
                          {Math.round(bus.speed || 0)} <span style={{ color: '#475569', fontWeight: 400 }}>km/h</span>
                        </div>
