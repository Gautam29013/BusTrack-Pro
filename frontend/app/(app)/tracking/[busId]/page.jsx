  ...
  return (
    <div style={{ height: '100%', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
      ...
      <div style={{ padding: '12px 16px', borderBottom: '1px solid rgba(255,255,255,0.06)', display: 'flex', alignItems: 'center', gap: '12px', flexShrink: 0, background: 'rgba(13,20,36,0.98)' }}>
        <Link href="/dashboard" style={{ display: 'flex', alignItems: 'center', gap: '6px', color: '#94a3b8', textDecoration: 'none', fontSize: '13px', padding: '6px 12px', borderRadius: '8px', border: '1px solid rgba(255,255,255,0.08)', transition: 'all 0.2s' }}>
          ← Back
        </Link>
        <div>
          ...
          {bus?.routeName && <p style={{ fontSize: '12px', color: '#94a3b8' }}>{bus.routeName}</p>}
        </div>
        ...
        <div style={{ width: '300px', display: 'flex', flexDirection: 'column', gap: '12px', overflowY: 'auto' }}>
          ...
          {bus?.latitude && (
            <motion.div
              ...
              style={{ padding: '16px' }}
            >
              <h3 style={{ fontWeight: 600, fontSize: '13px', color: '#94a3b8', marginBottom: '12px', textTransform: 'uppercase', letterSpacing: '0.5px' }}>GPS Coordinates</h3>
