  ...
  return (
    <div style={{ padding: '24px', maxWidth: '800px', margin: '0 auto' }}>
      <div style={{ marginBottom: '24px' }}>
        ...
        <p style={{ color: 'var(--text-secondary)', fontSize: '14px' }}>Review your past travels and tracked routes.</p>
      </div>
      ...
      {history.length === 0 ? (
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          {history.map((trip, i) => (
            ...
            >
              <div style={{ width: '48px', height: '48px', borderRadius: '12px', background: trip.route_color || 'var(--accent-blue)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '20px', color: 'white', fontWeight: 800, flexShrink: 0 }}>
                {trip.route_number || 'B'}
              </div>
              <div style={{ flex: 1 }}>
